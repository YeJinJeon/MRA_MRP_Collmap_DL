...
class _Config(BaseDceMraConfig):
    ...
    def __init__(self, old_root_dir="/data1/yejin/mra_npy_new",
        ...
        self.log_file_dir = "/data1/yejin/compu/mra_v2/drnn/log_file"
        self.model_save_dir = "/data1/yejin/compu/mra_v2/drnn/pretrain"
        self.predict_save_dir = "/data1/yejin/compu/mra_v2/drnn/result"
        self.evaluation_metrics_save_dir = "/data1/yejin/compu/mra_v2/drnn/evaluation_metrics"
        self.summary_writer_folder_dir = "/data1/yejin/compu/mra_v2/drnn/runs"
        ...
        self.network_architecture = {
            "file": "network_architecture/original_drnn",
            "parameters": {
                "n_channels": 40,
                "growth_rate": 4,
                "reduction": 0.5,
