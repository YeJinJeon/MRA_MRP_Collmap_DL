...
class _Config(BaseDceMraConfig):
    ...
    def __init__(self, old_root_dir="/data1/yejin/mra_npy_new",
        ...
        self.log_file_dir = "/data1/yejin/compu/mra_v3/3d_unet/log_file"
        self.model_save_dir = "/data1/yejin/compu/mra_v3/3d_unet/pretrain"
        self.predict_save_dir = "/data1/yejin/compu/mra_v3/3d_unet/result"
        self.evaluation_metrics_save_dir = "/data1/yejin/compu/mra_v3/3d_unet/evaluation_metrics"
        self.summary_writer_folder_dir = "/data1/yejin/compu/mra_v3/3d_unet/runs"
