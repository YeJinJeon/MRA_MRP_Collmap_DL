...
class _Config(BaseDceMraConfig):
    ...
    def __init__(self, old_root_dir="/data1/yejin/mra_npy_new",
        ...
        self.log_file_dir = "/data1/yejin/compu/mra_v2/3d_unet_tgm_trm/log_file"
        self.model_save_dir = "/data1/yejin/compu/mra_v2/3d_unet_tgm_trm/pretrain"
        self.predict_save_dir = "/data1/yejin/compu/mra_v2/3d_unet_tgm_trm/result"
        self.evaluation_metrics_save_dir = "/data1/yejin/compu/mra_v2/3d_unet_tgm_trm/evaluation_metrics"
        self.summary_writer_folder_dir = "/data1/yejin/compu/mra_v2/3d_unet_tgm_trm/runs"

        # self.pretrain = '/data1/yejin/compu/mra_v2/3d_unet_tgm_trm/pretrain/UnetBackboneTgmTrm_1AveragePhaseLoss_Adam_inputs_labels_labels_weight_for_each_phase_mask_2022-07-30-22-58-47_seed42/model_256.pth'

        self.network_architecture = {
            "file": "network_architecture/unet_backbone_tgm_trm_v2",
            "parameters": {
                "n_channels": 40,
                "n_classes": 5,
                "n_slices": 20, #############################################
