...
v2: do not concatenate 
"""

import sys
sys.path.append('.')
from network_architecture.unet_3d.unet_parts import *
from network_architecture.unet_3d.reconet_head_v2 import ReconetHead
import torch.nn.functional as F
import torch

class UnetBackboneTgmTrmV2(nn.Module):
    def __init__(self, n_channels, n_classes, n_slices, device, rank, trilinear=True):
        super(UnetBackboneTgmTrmV2, self).__init__()
